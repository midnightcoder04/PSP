-- Migration 026: Fix active-only counts in get_admin_overview.
-- total_participants previously counted ALL profiles with role='participant',
-- including deactivated accounts. Now counts only is_active = true.
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'total_participants',     (SELECT COUNT(*) FROM public.profiles  WHERE role = 'participant' AND is_active = true),
