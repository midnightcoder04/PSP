...
specs/005-iter5-ux-fixes/plan.md
...
sections, and the per-question answer-field rule. The current plan above
layers Iteration 5's UX fixes — sidebar collapse, slide-state reset on section
change, WATUSI count verification, Personality two-question quiz + DISC
read-through, slide-spacing fix, and info-slide single-column layout — on top.)
<!-- SPECKIT END -->
